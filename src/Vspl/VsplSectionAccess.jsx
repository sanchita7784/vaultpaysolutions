...
const GrokAccessSection = () => {
  return (
    <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 xl:max-w-10xl space-y-16 sm:space-y-24 md:space-y-32 bg-gradient-to-b from-stone-950 to-black py-12 sm:py-16">
      <div>
...
export default GrokAccessSection;